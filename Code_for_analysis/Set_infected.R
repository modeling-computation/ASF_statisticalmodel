...
# Accuracy
library(MLmetrics)
Accuracy(pred[which(true > 0)], true[true>0])
Accuracy(pred2[which(true2 > 0)], true2[true2>0])
Accuracy(pred3[which(true3 > 0)], true3[true3>0])

MAE(pred[which(true > 0)], true[true>0])
MAE(pred2[which(true2 > 0)], true2[true2>0])
MAE(pred3[which(true3 > 0)], true3[true3>0])
